  ...
  function ready (error, counties, names) {
    ...
    function update(v, t) {
      ...
      d3.json(p, function(error, json) {
        ...
        // d3.json(p2, function(error, json2) {
          ...
          // var districts2 = topojson.object(json2, json2.objects.out).geometries;

          // districts2.forEach(function(d) {
          //   filter = names['table'][time-1][d.properties.state];
          //   if (filter != undefined) {
          //     filter = filter[d.properties.district];
          //     if (filter != undefined) {
          ...
          // var county2 = svg.selectAll(".districts").data(districts2);
          // county2.enter()
          //   .insert("path")
          //   .attr("state", function(d,i) { return d.properties.state; })
          //   .attr("dist", function(d,i) { return d.properties.district; })
